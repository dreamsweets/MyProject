...
bool Graphics::Initialize(HWND hwnd, int width, int height)
{
	...
	if (!InitializeScene()) {
		ErrorLogger::Log("Failed to Initializing Scene.");
		return false;
	}
...
bool Graphics::InitializeDirectX(HWND hwnd)
{
	try
	{
		...
		COM_ERROR_IF_FAILED(hr, "Failed to create rasterizer state_cullFront.");
