...
ModelClass::ModelClass() : m_vertexBuffer(0), m_indexBuffer(0), m_Texture(0)
{ }
...
//deviceContext한테 버퍼에 있는 놈들을 그리라고 명령함.
...
//버텍스 와 인덱스 정보를 가지고 device에게 버퍼 생성하도록 명령하는 놈.
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	//indices[3] = 3; // bottem left 
	//indices[4] = 0; // top right
	...
	// 인덱스 버퍼와 버텍스 버퍼가 생성되었으므로 할당 해제 시킨다.
	delete[] vertices;
	vertices = 0;
	delete[] indices;
	indices = 0;
