...
public:
	...
	void Shutdown();
	//bool Render(ID3D11DeviceContext * deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DMATRIX projectionMatrix, ID3D11ShaderResourceView * texture);
